...
<!-- description-start -->
This is the official GitHub repo for the NoAISpawnEggs mod. Spawn mobs quickly with no AI! You can download this mod from [CurseForge](https://www.curseforge.com/minecraft/mc-mods/no-ai-spawn-eggs) or [Modrinth](https://modrinth.com/mod/no-ai-spawn-eggs). Please report issues [here](https://github.com/Darkhax-Minecraft/NoAI-Spawn-Eggs/issues).
<!-- description-end -->
...
NoAISpawnEggs is proudly sponsored by Nodecraft! Play your favorite games with your friends using their high
